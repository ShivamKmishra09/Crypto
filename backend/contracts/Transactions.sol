...
contract Transactions {
    ...
    uint256 private tokenAddressCount;

    event TokenAddressAdded(address tokenAddress);
    ...
    function getTokenAddressCount() public view returns (uint256) {
        return tokenAddressCount;
    }
